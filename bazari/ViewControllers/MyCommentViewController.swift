...
class MyCommentViewController: UIViewController {
    ...
    func loadAllPosts() {
        ...
        Api.MyCommentPosts.observeMyAllPosts(userId: currentUid) { (post, postCount) in
...
extension MyCommentViewController: UICollectionViewDataSource, UICollectionViewDelegate {
