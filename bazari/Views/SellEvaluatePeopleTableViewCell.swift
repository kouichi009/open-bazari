//
//  SellEvaluatePeopleTableViewCell.swift
//  GadgetMarket
//
...
protocol SellEvaluatePeopleTableViewCellDelegate {
    func back3(valueStatus: String, valueComment: String)
}


class SellEvaluatePeopleTableViewCell: UITableViewCell {
    ...
    var delegate: SellEvaluatePeopleTableViewCellDelegate?
    ...
    @IBAction func sendValue_TouchUpInside(_ sender: Any) {
        ...
        sendValueButton.isEnabled = false
            delegate?.back3(valueStatus: valueStatus, valueComment: valueInputTextView.text!)
